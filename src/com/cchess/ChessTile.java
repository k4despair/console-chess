...
public class ChessTile {
    ...
    public void putFigure(ChessFigure figure) {
        this.figure = figure;
    }
    ...
    public boolean isHit(Side side) {
        return (side == Side.WHITE) ? hitW : hitB;
    }
    ...
    public void setHit(Side side) {
        if (side == Side.WHITE) hitW = true;
        else hitB = true;
    }
