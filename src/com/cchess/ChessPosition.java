...
public class ChessPosition {
    ...
    public ChessTile getTile(TileCoord cell) {
        return cell.isValid() ? board[cell.getV()][cell.getH()] : null;
    }

    public ChessFigure getFigure(TileCoord cell) {
        return cell.isValid() ? board[cell.getV()][cell.getH()].getFigure() : null;
    }
    ...
    public void copyPosition(ChessPosition origin) {
        ...
        figures.clear();
        for (int i = 0; i < origin.figures.size(); i++)
            if (origin.figures.get(i).getTile() != null) figures.add(origin.figures.get(i).copy(this));
